...
export default class VideoPlayer extends Component {
  ...
  onSeekBarLayout({ nativeEvent }) {
    ...
    this.seekBarHeight = nativeEvent.layout.height - padding;
  }
  ...
  onSeekGrant(e) {
    this.seekTouchStart = this.state.isFullScreen ? e.nativeEvent.pageY : e.nativeEvent.pageX;
  ...
  onSeek(e) {
    const diff = this.state.isFullScreen ? (e.nativeEvent.pageY - this.seekTouchStart) : (e.nativeEvent.pageX - this.seekTouchStart);
    const ratio = 100 / this.seekBarWidth;
    const progress = this.state.isFullScreen ? (this.seekProgressStart - ((ratio * diff) / 100)) : (this.seekProgressStart + ((ratio * diff) / 100)) ;
